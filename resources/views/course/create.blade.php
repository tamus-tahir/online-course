<x-backend>
    ...
    <section class="section card shadow p-3">
        ...
        <form action="{{ route('course.store') }}" method="post" enctype="multipart/form-data" id="form">
            @csrf
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('trailer') is-invalid @enderror "
                            id="trailer" name="trailer" required value="{{ old('trailer') }}">
                        @error('trailer')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <img src="{{ asset('backend/img/noimage-landscape.png') }}" alt="" class="w-100 rounded"
                        id="preview">
